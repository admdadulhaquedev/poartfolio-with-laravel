...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			.Heading {font-family: Signika, Helvetica Neue, Helvetica, sans-serif !important;}
			 ...
			 @media only screen and (min-width:799px)
            {
                ...
                .width680 {width:680px !important; max-width:680px !important;}
			 ...
			 @media only screen and (max-width:799px)
            {
				...
				.width680 {width:100% !important; max-width:100% !important;}
				.width50percent {width:50% !important; max-width:50% !important;}
		   }
			...
			{
				.display-width-child .width272 { width:100% !important; max-width:100% !important;}
				.display-width-child .width290 {width:290px !important;}
			...
			{
				.butn-font {font-size: 10px !important;}
				.display-width-child .width290 { width:100% !important; max-width:100% !important;}
			}
		</style>
	</head>
	<body>
		...
		<!-- VIEW STARTS -->
		<repeater>
			<layout label='VIEW STARTS'>
				<table align="center" bgcolor="#4F595B" border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-top: 25px;">
					<tbody>
						<tr>
							<td align="center">
								<!--[if (gte mso 9)|(IE)]>
								...
								<div style="display:inline-block; width:100%; max-width:680px; vertical-align:top;" class="width680">
									<!-- ID:BG VIEW BROWSER OPTIONAL -->
									<table align="center" bgcolor="#4F595B" border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%" style="max-width:680px;">
										<tbody>
											<tr>
																							...
																							<tr>
																								<td align="center">
																									<table align="center" border="0" cellpadding="0" cellspacing="0" style="width:auto !important;">
																										<tr>
																											<!-- ID:TXT VIEW BROWSER -->
																											<td align="center" style="color:#333333;" width="128">
																												 <a href="#" style="color:#333333; text-decoration:none;">
                                                                                                                    <img src="{{ asset('uploads/settings') }}/{{ Settings()->sticky_logo }}" alt="128x36" width="128" height="36" style="margin:0; border:0; padding:0; display:block;" editable="true" label="128x36">
                                                                                                                </a>
																											</td>
																										</tr>
																									</table>
		...
		<!-- VIEW ENDS -->
		<!-- ACTIVATE YOUR ACCOUNT STARTS -->
		<repeater>
			<layout label='ACTIVATE YOUR ACCOUNT STARTS'>
				<table align="center" bgcolor="#4F595B" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tbody>
						<tr>
							<td align="center">
								<!--[if (gte mso 9)|(IE)]>
								<table aria-hidden="true" border="0" cellspacing="0" cellpadding="0" align="center" width="680" style="width: 680px;">
									<tr>
										<td align="center" valign="top" width="100%" style="max-width:680px;">
											<![endif]-->
								<div style="display:inline-block; width:100%; max-width:680px; vertical-align:top;" class="width680">
									<!-- ID:BG ACTIVATE OPTIONAL -->
									<table align="center" bgcolor="#42C0D3" border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%" style="max-width:680px;">
										<tbody>
											<tr>
												<td align="center" class="res-padding">
													<!--[if (gte mso 9)|(IE)]>
														...
														<table align="center" border="0" class="display-width-inner" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
															...
															<tr>
																...
																<td align="center" class="MsoNormal" style="color:#ffffff; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-weight:600; font-size:22px; line-height:32px; letter-spacing:1px;">
																	<multiline>YOUR ACCOUNT HAS NOT BEEN ACTIVED YET </multiline>
		...
		<!-- ACTIVATE YOUR ACCOUNT ENDS -->

		<!-- CLICK TO ACTIVATE STARTS -->
		<repeater>
			<layout label='CLICK TO ACTIVATE STARTS'>
				<table align="center" bgcolor="#4F595B" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tbody>
						<tr>
							<td align="center">
												...
												<td align="center" class="res-padding">
													...
													<div style="display:inline-block; width:100%; max-width:600px; vertical-align:top;" class="width600">
														<table align="center" border="0" class="display-width-inner" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
															...
															<tr>
																<td align="center" style="padding:0 10px;">
																	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
																		<tr>
																			<!-- ID:TXT CONTENT -->
																			<td align="center" class="MsoNormal" style="color:#666666; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size:13px; line-height:23px; mso-line-height-rule: exactly;">
																				<multiline>
                                                                                    Plase Check your Email, A fresh verification link has been sent to your email address , If you did not receive the email click 'Click Hear' button
                                                                                </multiline>
																			</td>
																		</tr>
																	</table>
															...
															<tr>
																<td align="center" class="button-width butn-center">
																	<!-- ID:BTN COMMON BUTTON -->
																	<table align="center" bgcolor="#f3402e" border="0" cellspacing="0" cellpadding="0" class="display-button" style="border-radius:3px;">
																		<tr>
																			<td align="center" valign="middle" class="MsoNormal" style="color:#ffffff; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size:13px; font-weight:700; letter-spacing:1px; padding:7px 12px;">
																				 <multiline>
                                                                                    <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                                                                        @csrf
                                                                                        <button style="background: transparent;border:0;color:#ffffff;cursor: pointer;" type="submit" class="btn btn-link p-0 m-0 align-baseline">CLICK HEAR</button>
                                                                                    </form>
                                                                                </multiline>
																			</td>
																		</tr>
															...
															<tr>
																<!-- ID:TXT LINK-2 -->
																<td align="center" class="MsoNormal" valign="middle" style="color:#444444; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size:13px; line-height:23px; padding:0 10px;">
																	 <multiline>
																								...
																								<td align="center" style="padding:5px 10px;">
																									<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
																										<tr>
																											...
																											<td align="left" class="MsoNormal txt-center" style="color:#ffffff; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size:13px; line-height:23px; letter-spacing:1px;">
																												<multiline> © All Rights Reserved. </multiline>
																											</td>
																										</tr>
																									</table>
																								</td>
																						...
																						<tr>
																							<td align="center" style="font-size:0;">
																								<!--[if (gte mso 9)|(IE)]>
																																	...
																																	<td width="145">
																																	<![endif]-->
																								<div style="display:inline-block; width:100%; max-width:135px; vertical-align:top;" class="div-width">
																									<table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width-child" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; width:100%; max-width:135px;">
																										<tr>
																											<td width="100%" style="font-size:0;">
																												&nbsp;
																											</td>
																								...
																								<!--[if (gte mso 9)|(IE)]>
																																	...
																																	<td width="215">
																																	<![endif]-->
																								<div style="display:inline-block; width:100%; max-width:205px; vertical-align:top;" class="div-width">
																									<table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width-child" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; width:100%; max-width:100%;">
																										<tbody>
																											<tr>
																												<td align="center" style="padding:5px 10px;">
																													<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
																														<tr>
																															...
																															<td align="right" class="MsoNormal txt-center" style="color:#ffffff; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size:13px; line-height:23px; letter-spacing:1px;">
																																<multiline>
                                                                                                                                    {{ ContactInfo()->address }}
                                                                                                                                    <br />
