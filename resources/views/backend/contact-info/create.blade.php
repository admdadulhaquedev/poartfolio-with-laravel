                        ...
                        <div class="row">
                            <div class="col-12 blog-details">
                                <form action="{{ route('post.store') }}" enctype="multipart/form-data" method="POST">
                                    ...
                                    @if (session("only_one_select"))
                                    <div class="alert alert-danger mt-2">
                                        {{ session("only_one_select") }}
                                    </div>
                                    @endif

                                    @if (session("post_sub_category"))
                                    <div class="alert alert-danger mt-2">
                                        {{ session("post_sub_category") }}
                                    </div>
                                    @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tags_name" name="tags_name" class="form-control"
                                            placeholder="">
...
<script>
    jQuery(document).ready(function () {
        ...
        $('#attached_video').on('click', function () {
            $(".video_box").removeClass("d-none");
            $(".images_box").addClass("d-none");
        });
        $('#attached_images').on('click', function () {
            $(".images_box").removeClass("d-none");
            $(".video_box").addClass("d-none");
        });
