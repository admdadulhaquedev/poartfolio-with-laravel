                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="datatable table table-hover table-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($only_trash_category as $key => $category)
                                        <tr>
                                            <td>
                                                {{ ++$key }}
                                            </td>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="profile.html">{{ $category->category_name }}</a>
                                                </h2>
                                            </td>
                                            <td class="text-right">
                                                <div class="actions">
                                                    <a href="{{ route('category.restore',$category->id) }}" class="btn btn-sm bg-info-light">
                                                        <i class="fa fa-trash-undo"></i>
                                                        Undo
                                                   </a>
                                                    <a data-id="{{ $category->id }}" data-toggle="modal" href="#delete" class="btn btn-sm bg-danger-light">
